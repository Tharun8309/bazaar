...
const CustomerProduct = ({product, cart}) => {
  ...
  const { addToCart, removeFromCart } = useContext(CustomerContext);
  ...
  return (
    <div key={product._id} className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden border border-gray-100">
      <div className="relative flex justify-center">
        <img 
          src={product.imageUrl}
          alt={product.name}
          className="w-40 h-40 object-cover mx-auto rounded-md bg-gray-100"
        />
