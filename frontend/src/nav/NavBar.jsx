      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between h-16 items-center">
          <div className="flex items-center">
            <Link to="/" className="text-2xl font-bold text-primary hover:text-secondary transition duration-300">
              Bazaar
            </Link>
            ...
            {isLoggedIn && userType === 'customer' && <div className="ml-10 flex items-center space-x-4">
              <Link to="/cart" className="relative flex items-center text-gray-700 hover:text-white hover:bg-indigo-600 px-4 py-2 rounded-lg text-sm font-medium transition duration-300">
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
